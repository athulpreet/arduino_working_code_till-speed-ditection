...
bool saveVehicleHeader() {
    ...
    Serial2.print("Saving header to: ");
    Serial2.println(HEADER_FILENAME);
    ...
    Serial2.println("Vehicle header saved successfully");
...
void setup() 
{
  ...
  myVehicleHeader.VEHICLE_OWNER_ID = 12345;
  myVehicleHeader.OWNER_PHONE_NO = 1234567890;
  ...
  myVehicleHeader.LIMITER_SERIAL = 987654;
  myVehicleHeader.DATE_OF_FITTING = 20230515;
  ...
  myVehicleHeader.AGENT_PHONE_NUMBER = 9110470625;
  ...
  if(result)
  Serial2.println("sucess_header");
  else
   Serial2.println("failed_heder");;
...
delay(20);
Serial2.println("Interrupt-based PWM Measurement on PB1");
  ...
  Serial2.println("Setup complete - waiting for signal...");
...
void loop()
{
 ...
 // delay(100);
   ...
   if (measurement_ready) {
    ...
    // Print results
    Serial2.print("Freq=");
    Serial2.print(freq, 2);
    Serial2.print("Hz - Duty=");
    Serial2.print(duty, 1);
    Serial2.println("%");
    
    // Debug info
    Serial2.print("Period=");
    Serial2.print(period);
    Serial2.print("us, Pulse=");
    Serial2.print(pulse_width);
    Serial2.println("us");
